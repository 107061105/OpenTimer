...
class RctNode {
  ...
  public:
    ...
    Statisical_delay delay(Split, Tran) const;
  ...
  private:
    ...
    TimingData<Statisical_delay, MAX_TRAN, MAX_SPLIT> _delay;
    TimingData<Statisical_delay, MAX_TRAN, MAX_SPLIT> _ldelay;
...
class Rct {
  ...
  public:
    ...
    Statisical_delay delay(const std::string&, Split, Tran) const;
...
class Net {
  ...
  private:
    ...
    std::optional<Statisical_delay> _delay(Split, Tran, Pin&) const;
    // yclo
